...
import com.example.aidanci.Fragment.BeidanciFragment;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void init() {
                ...
                beginTransaction.replace(R.id.content_layout, new BeidanciFragment());//初始页面
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.first:
                beginTransaction.replace(R.id.content_layout, new BeidanciFragment());
